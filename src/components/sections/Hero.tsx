    ...
    <section className="relative z-20 isolate min-h-[100svh] bg-[#0B0B0B] text-white" id="top">
      ...
      <div className="relative z-30 mx-auto flex min-h-[100svh] w-full max-w-[1400px] items-center px-4 pb-14 pt-24 sm:px-6 md:px-16 lg:pt-24">
        <div className="w-full md:max-w-[54%]">
          ...
          <span className="block text-sm mt-6 md:mt-8 tracking-[0.08em]">EGÉSZSÉGFÓKUSZÚ EDZÉS</span>
      ...
      <a
        ...
        className="absolute left-1/2 z-[70] -translate-x-1/2 bottom-3 md:bottom-4 text-[#55C493] transition hover:scale-105"
      >
      ...
      <svg className="hero-bottom-wave md:translate-y-0 -translate-y-6" viewBox="0 0 1440 220" preserveAspectRatio="none" aria-hidden="true">
        <path
